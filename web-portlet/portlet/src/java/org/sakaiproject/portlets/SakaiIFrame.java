...
public class SakaiIFrame extends GenericPortlet {
    ...
    // End of included constants
    
	// Helper
	public class SessionState {
		private PortletSession ps;
	
  		SessionState(PortletSession ps) {
		  this.ps = ps;
		}

		public String getAttribute(String key) {
			System.out.println("Getting atttribute key="+key);
			String retval = (String) ps.getAttribute(key);
			System.out.println("Found Attribute="+retval);
			if ( retval == null ) retval = "";
			return retval;
		}
		public void setAttribute(String key, String value) {
			ps.setAttribute(key,value);
		}
	}

    // TODO: Much work to do here to replicate "special"
    ...
    public void doView(RenderRequest request, RenderResponse response)
		...
		response.setTitle(ToolManager.getCurrentPlacement().getTitle());
...
// System.out.println("source="+source+" height="+height);
	...
	SessionState pSession = new SessionState(request.getPortletSession(true));

	buildOptionsPanelContext(context, pSession);
    ...
    // Beginning of included code methods
...
*/
	 ...
	 */
	public String buildOptionsPanelContext( Context context, SessionState state)
	{
